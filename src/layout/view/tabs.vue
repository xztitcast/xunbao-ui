...
const updateClosedTabs = (closedTabs, isTransform) => {
  if (isTransform) {
...
<template>
  <div class="tt-view-tab-wrap">
    <el-tabs class="tt-view-tab" v-model="state.activeTabName" @tab-click="onTabClick" @tab-remove="onTabRemove">
    ...
    <el-dropdown trigger="click" placement="bottom-end" class="tt-view-tab-ops" @command="onClose">
      <template #dropdown>
        <el-dropdown-menu>
