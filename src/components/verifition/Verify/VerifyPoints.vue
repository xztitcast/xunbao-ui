...
<script type="text/babel">
     ...
     * @description 点选
     * */
    import { resetSize, aesEncrypt, _code_chars, _code_color1, _code_color2} from '@/utils'
    import { onMounted, reactive, ref, nextTick, toRefs ,getCurrentInstance, watch} from 'vue';
            ...
            let secretKey = ref(''),           //后端返回的ase加密秘钥
                ...
                function getPictrue() {
                    ...
                    baseService
                        ...
                        barAreaBorderColor.value = '#ddd'
                        if (data && data.code === 0) {
                            pointBackImgBase.value = data.result.originalImageBase64
                            backToken.value = data.result.token
                            secretKey.value = data.result.secretKey
                            poinTextList = data.result.wordList
