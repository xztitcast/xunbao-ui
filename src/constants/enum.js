 ...
 * 页面渲染布局
 */
export const EPageLayoutEnum = Object.freeze({
  page : "page",
 ...
 * 导航模式
 */
export const ESidebarLayoutEnum = Object.freeze({
  /**
   * 左侧导航
   */
  Left : "left",
 ...
 * 主题设置
 */
export const EThemeSetting = Object.freeze({
  /**
   * 侧边栏风格
   */
  Sidebar : "sidebar",
 ...
 * 系统框架事件枚举
 */
export const EMitt = Object.freeze({
  /**
   * 全局加载
   */
  OnLoading : "onLoading",
 ...
 * 主题是key
 */
export const EThemeColor = Object.freeze({
   /**
   * 主题色
   */
